document.addEventListener('DOMContentLoaded', () => {
    ...
    const ramos = [
        ...
        { id: 'IND-124', nombre: 'Computac. I', creditos: 6, semestre: 2, prerequisitos: ['IND-114'] },
        // Semestre 3
        ...
        { id: 'IND-213', nombre: 'Prob. y Estadística', creditos: 6, semestre: 3, prerequisitos: ['IND-121', 'IND-122'] },
        ...
        { id: 'IND-334', nombre: 'Módulo Integ. CC.BB.', creditos: 6, semestre: 4, prerequisitos: ['IND-214'] },
        // Semestre 5
        ...
        { id: 'IND-313', nombre: 'Diseño Ind. y Dib. Tec.', creditos: 6, semestre: 5, prerequisitos: ['IND-221'] },
        { id: 'IND-314', nombre: 'Adm. y RRHH', creditos: 6, semestre: 5, prerequisitos: ['IND-334'] },
        // Semestre 6
        ...
        { id: 'IND-324', nombre: 'Contab. y Finanzas', creditos: 6, semestre: 6, prerequisitos: ['IND-312'] },
        { id: 'IND-325', nombre: 'Base de Datos', creditos: 4, semestre: 6, prerequisitos: ['IND-334'] },
        // Semestre 7
        { id: 'IND-411', nombre: 'Investiga. Operaciones', creditos: 6, semestre: 7, prerequisitos: ['IND-322'] },
        { id: 'IND-412', nombre: 'Procesos Industriales', creditos: 6, semestre: 7, prerequisitos: ['IND-321'] },
        { id: 'IND-413', nombre: 'Emprend. y Creación Empresas', creditos: 6, semestre: 7, prerequisitos: ['IND-324'] },
        { id: 'IND-414', nombre: 'Ingeniería Económica', creditos: 6, semestre: 7, prerequisitos: ['IND-323'] },
        { id: 'IND-415', nombre: 'Metodología Investigac.', creditos: 6, semestre: 7, prerequisitos: ['IND-334'] }, // Prerrequisito H1
        { id: 'IND-425', nombre: 'Módulo Integ. Lic. (Práctica 1)', creditos: 10, semestre: 7, prerequisitos: ['IND-325'] }, // Prerrequisito H1
        // Semestre 8
        ...
        { id: 'IND-513', nombre: 'Formal. y Ev. de Proyectos', creditos: 3, semestre: 9, prerequisitos: ['IND-423'] },
        { id: 'IND-514', nombre: 'Propiedad Intelectual', creditos: 6, semestre: 9, prerequisitos: ['IND-424'] },
        { id: 'IND-515', nombre: 'Marketing Estrat. Comer. Tec.', creditos: 5, semestre: 9, prerequisitos: ['IND-415'] }, // Prerrequisito H2
        // Semestre 10
        { id: 'CFG3', nombre: 'Certificación III', creditos: 5, semestre: 10, prerequisitos: ['CFG2'] },
        { id: 'IND-521', nombre: 'Gestión Calidad Prod.', creditos: 6, semestre: 10, prerequisitos: ['IND-511'] },
        { id: 'IND-522', nombre: 'Electivo Ev. Proyectos', creditos: 6, semestre: 10, prerequisitos: ['IND-512'] },
        { id: 'IND-523', nombre: 'Plan. Estrat. y Gestión Negocios', creditos: 6, semestre: 10, prerequisitos: ['IND-513'] },
        { id: 'IND-524', nombre: 'Gestión Proyectos I+D+e', creditos: 6, semestre: 10, prerequisitos: ['IND-514'] },
        { id: 'IND-525', nombre: 'Inteligencia Comp. y Vig. Tec.', creditos: 5, semestre: 10, prerequisitos: ['IND-515'] },
        // Semestre 11
        { id: 'IND-611', nombre: 'Electivo G. Oper. y Proc. Indu.', creditos: 6, semestre: 11, prerequisitos: ['IND-521'] },
        { id: 'IND-612', nombre: 'Electivo Gestión Negocios', creditos: 6, semestre: 11, prerequisitos: ['IND-522'] },
        { id: 'IND-613', nombre: 'Módulo Integrador Formación Profesional', creditos: 18, semestre: 11, prerequisitos: ['IND-523', 'IND-524', 'IND-525'] }, // Prerrequisito H3
    ];
